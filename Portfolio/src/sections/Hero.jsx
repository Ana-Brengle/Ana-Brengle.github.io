...
const skills = ["React", "JavaScript", "TypeScript", "C#", "MongoDB", "SQL", "ASP.NET MVC", "Node.js", "Tailwind CSS", "HTML"]
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(30)].map((_, i) => (
          <div key={i} className="absolute w-1 h-1.5 rounded-full opacity-60"
            style={{ backgroundColor: "#20B2A6", left: `${Math.random() * 100}%`, top: `${Math.random() * 100}%`, animation: `slow-drift ${15 + Math.random() * 20}s ease-in-out infinite`, animationDelay: `${Math.random() * 5}s` }}
          />
        ))}
      </div>
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                ...
                <br />front to<br />
                <span className="font-serif italic font-normal text-white">back.</span>
              </h1>
              <p className="text-lg text-muted-foreground animate-fade-in animation-delay-300">
                Hi, I'm Ana — a web developer specializing in MERN Stack, JavaScript, C# and more. Building clean, scalable web applications.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: FaGithub, href: "https://github.com/Ana-Brengle" },
          ...
          <div className="relative max-w-md mx-auto">
            <img src="/public/IMG_0624.jpg" alt="Ana Brengle" className="w-full aspect-[4/5] object-cover rounded-2xl" />
        ...
        <div className="mt-20 animate-fade-in animation-delay-600">
          <p className="text-sm text-muted-foreground mb-6 text-center">Languages I work with.</p>
