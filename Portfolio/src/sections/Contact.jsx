...
const contactInfo = [
  { icon: Mail, label: "Email", value: "anajobrengle@gmail.com", href: "mailto:anajobrengle@gmail.com" },
  { icon: Phone, label: "Phone", value: "+1 (555) 123-4567", href: "tel:+15551234567" },
  { icon: MapPin, label: "Location", value: "St. Louis, MO", href: "#" },
]

export const Contact = () => {
  useEffect(() => {
    if (window.jotformEmbedHandler) {
      window.jotformEmbedHandler("iframe[id='JotFormIFrame-243295339146058']", "https://form.jotform.com/")
    }
  }, [])
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="glass p-4 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300 overflow-hidden">
            <iframe
              ...
              frameBorder="0"
              style={{ minWidth: "100%", maxWidth: "100%", height: "1050px", border: "none" }}
              scrolling="no"
            />
          </div>
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                I'm still in school, but I'm currently looking for an internship to gain experience. Like my work? Let's Talk!
              </p>
            </div>
          </div>
        </div>
