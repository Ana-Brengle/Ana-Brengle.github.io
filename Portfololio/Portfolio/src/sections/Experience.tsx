const experiences = [
  {
    ...
    description:
      "Prepared and served frozen custard products to ensure customer satisfaction.",
    current: true,
  },
  {
    period: "2024 - Present",
    ...
    company: "Leann Brand",
    description:
      "Provided daily care for pets, including feeding, walking and administrating medication.",
    current: false,
  },
];
